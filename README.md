...
Explicit confirmation is required before purchasing, applying power to new wiring, connecting batteries or actuators to power, uploading movement-capable firmware, first movement, first body contact for a wearable or haptic robot, increasing motion energy, autonomous or floor movement, cameras, always-listening microphones, local sensitive-data collection or storage, sensitive-data transmission, dangerous tools, mains voltage, high-current work, custom battery packs, or unresolved electrical compatibility.
